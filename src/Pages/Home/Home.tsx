        ...
        <div className={style['container']}>
          ...
          <footer className={style['footer']}>
            <div className={style['info-group']}>
              ...
              <div className={style['dev-group']}>
                <div>
                  <p>前端</p>
                  <p>
                    <a rel="noreferrer" href="https://github.com/LoisChen68" target="_blank">Lois</a>
                  </p>
                  <p>
                    <a rel="noreferrer" href="https://github.com/Gino-Hsu" target="_blank">Gino</a>
                  </p>
                </div>
                <div>
                  <p>後端</p>
                  <p>
                    <a rel="noreferrer" href="https://github.com/AdrieneTZ" target="_blank">Adriene</a>
                  </p>
                  <p>
                    <a rel="noreferrer" href="https://github.com/seanlin1125" target="_blank">Sean</a>
                  </p>
                </div>
              </div>
            </div>
            <p className={style['github']}>
              <AiFillGithub />
              <a rel="noreferrer" href="https://github.com/LoisChen68/careerforum" target="_blank" >Github</a>
            </p>
